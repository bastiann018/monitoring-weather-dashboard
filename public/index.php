<?php
// C:\xampp\htdocs\weather-dashboard\public\index.php
...
<div class="app">
  ...
  <main class="content">
    ...
    <div class="muted"><?= strftime('%A, %d %B %Y pukul %H:%M'); ?></div>
    ...
    <section class="card mt">
      ...
      <div class="footer">Auto refresh tiap 5 detik</div>
    </section>
...
<script>
  var API_BASE='../api'; // DIGANTI DARI 'const' MENJADI 'var'
